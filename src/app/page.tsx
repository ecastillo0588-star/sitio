          ...
          <div className="hero-inner" style={{maxWidth:1120, margin:"0 auto", padding:"0 1.5rem", display:"grid", gridTemplateColumns:"minmax(0,1.5fr) minmax(0,1fr)", gap:"3rem", alignItems:"flex-start"}}>
            <div className="hero-copy">
              ...
              <p className="hero-sub" style={{fontSize:"1rem", color:"var(--muted)", maxWidth:580, marginBottom:"1rem"}}>
                LLEGÓ EG HealthSolutions: La nueva y mejor forma de gestionar tus turnos en un solo lugar, con seguridad y privacidad. Permite diferenciar fácilmente entre pacientes nuevos, controles y turnos de urgencia.
              </p>
        ...
        <section id="planes" style={{padding:"4rem 0", background:"var(--bg)"}}>
          <div style={{maxWidth:1120, margin:"0 auto", padding:"0 1.5rem"}}>
            ...
            <p style={{marginTop:".6rem", fontSize:".95rem", color:"var(--ink)", background:"#f8fafc", border:"1px solid var(--line)", borderRadius:10, padding:".9rem 1rem"}}>
              ¿Tenés un centro médico o son más de 10 profesionales?{' '}
              <a href="https://wa.me/541138492392?text=Quiero%20hablar%20sobre%20planes%20personalizados%20para%20un%20centro%20o%20grupo%20grande" target="_blank" rel="noopener" style={{color:"#0f5132", fontWeight:700, textDecoration:"underline"}}>
                Consultanos
              </a> por planes personalizados para tu equipo.
            </p>
